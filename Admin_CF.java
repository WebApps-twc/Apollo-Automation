...
public void turnOnOffSelected(String feature,WebDriver driver, String br, int numSuspended,int tab,int val)
  ...
  public void turnoff(WebDriver driver, String br, String acc,int val)
  	{
                  ...
                  focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[1]/span[2]/label/span[2]")),br);
                  ...
                  focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[1]/span[2]/label/span")),br);
                  String num=randomNO(3333,6666);
                  driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/input")).clear();
                  driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/input")).sendKeys(phoneline+num);
  ...
  public String TNcheck(String ac, String acode,WebDriver driver, int check,String br,int val) throws Exception
  {
         	...
         	int check1=check;
         	driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/input")).clear();
            driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/input")).sendKeys(ac);      
          
         	if(check1==2)
         	{                      
                 driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[3]/input")).clear();
                 driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[3]/input")).sendKeys(acode);
         	}
         	if(check1==3)
         	{
                 ac=2+Acccode;
                 logger.info("ac"+ac);
                 driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/input")).clear();
                 driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/input")).sendKeys(acode);
         	}
                                ...
                                if(!(InternalException(driver,br)))
                                  {
                                    ...
                                    if(!(InternalException(driver,br)))
                                    {
                						...
                						WebElement subMenu = driver.findElement(By.xpath(".//*[@id='newFeature']/div[2]"));
                						actions.moveToElement(subMenu);
                						actions.click().build().perform();
                						
                						if(driver.findElement(By.xpath(".//*[@id='newFeature']/div[2]")).isDisplayed())
                						{
                						    System.out.println("Tooltip is coming up fine");
                						    statusTracker(br,"","CF Modal pop up is displayed",driver.findElement(By.xpath(".//*[@id='newFeature']/div[2]")).getText(),"");						    
                						 }
                						else
                						{
                                    	...
                                    	{                                   
                                    		...
                                    		{
                                    			int a1=1;
                                    			focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/div/i")),br);
                                        		statusTracker(br,"","The Verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/div/div/div[2]")).getText(),"");
                                    			
                                    			String acntcd= driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/div/input")).getAttribute("class");
                                    			logger.info("acntcd is"+acntcd);
                                    			if(acntcd.contains("not"))
                                    			{
                                    				logger.info("check is");
                                    				statusTracker(br,"","The Account code is"+Acccode,"","");    
                                    				focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/div/label")),br);           
                                    				driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[3]/input")).sendKeys(Acccode);
                                    			}
                                    			else
                                    			{
                                    				driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[3]/input")).clear();
                                    				driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[3]/input")).sendKeys(Acccode);
                                    			}
                                    			logger.info("check is");
                                    		...
                                    		{
                                    			int a2=2;       
                                    			focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/label/i")),br);
                                        		statusTracker(br,"","The Non-verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/label/div/div[2]")).getText(),"");
                                    			
                                    			driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/input")).clear();
                                    			driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/div[2]/input")).sendKeys("8956325485");
                                    			...
                                    			driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/input")).clear();
                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td[1]/div/input")).sendKeys("9193220001");
                                    			
                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody[1]/tr[2]/td[1]/div/div[3]/button[1]")).click();
                                        		  
                                          	  	Thread.sleep(2000);                                           
                                                if(driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody[1]/tr[2]/td[1]/div/div[3]/button[1]")).getAttribute("disabled").equals("disabled"))
                                                {
                                              	  logger.info("Success");
                                              	 // state="Pass";
                                              	  statusTracker(br,"Pass","Verify if the user is able to cancel the changes made","Successfully be able to cancel order","Should be able to successfully cancel the order");
