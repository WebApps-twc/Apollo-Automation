...
public class Admin_CFU extends CommonFunctions
{
                String table, tns[];
                                  ...
                                  System.out.println("a");
                                    ...
                                    System.out.println("checkpoint1");
                                    	...
                                    	{                                                  
                                    		...
                                    		statusTracker(br,"","The CFU tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[2]/div[2]/div[2]")).getText(),"");	                                    		
                                    	}
                                    	...
                                    	{                                   
                                    		if(driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div["+bval+"]/div/div[2]")).getText().contains("Local Calls Only"))
                                    		{
                                        		...
                                        		statusTracker(br,"","The Verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[2]/div/div/div[2]")).getText(),"");
                                    		...
                                    		{
                                    			int a2=2,val=3;       
                                    			focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div["+bval+"]/div/div[2]/label/i")),br);
                                        		statusTracker(br,"","The Non-verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[2]/label/div/div[2]")).getText(),"");
