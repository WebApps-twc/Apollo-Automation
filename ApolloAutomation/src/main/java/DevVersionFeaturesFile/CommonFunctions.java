...
public abstract class CommonFunctions {
	...
	public static String spath,spath1,fname,offer_rel1,offer_com ;
	...
	public void focusClick(WebDriver driver,WebElement elementToClick,String br)
	{
...
public Boolean selectFromDropDown(WebDriver driver,String locator, String value) {
	...
	public int FeatureListIncomingCW(WebDriver driver,int count1, String featureName)
	  ...
	  public void turnOnOffCallLog(int featureOrder, WebDriver driver, String br,int tab) throws InterruptedException
	  {
	  	  ...
	  	  if(envvalue==0)
	  		  val=17; 
			  Boolean r=driver.findElement(By.id("lines1")).isSelected();
			  System.out.println("bool : "+r);
				 
			  driver.findElement(By.cssSelector("div[id='collapseFeature1'] [class='switch enabled']")).click();
			  Thread.sleep(2000);
			  
			  driver.findElement(By.xpath(".//*[@id='collapseFeature1']/div[2]/form/div/button[2]")).click();
	  ...
	  public void turnOnOffReturn69(int featureOrder, WebDriver driver, String br,int tab) throws InterruptedException
	  {
	  	  ...
	  	  if(envvalue==0)
	  		  val=17; 
			  Boolean r=driver.findElement(By.id("lines2")).isSelected();
			  System.out.println("bool : "+r);
				 
			  driver.findElement(By.cssSelector("div[id='collapseFeature2'] [class='switch enabled']")).click();
			  Thread.sleep(2000);
			  
			  driver.findElement(By.xpath(".//*[@id='collapseFeature2']/div[2]/form/div/button[2]")).click();
	  ...
	  public void turnOnOffLastnumberRedial(int featureOrder, WebDriver driver, String br,int tab) throws InterruptedException
	  {
	  	  ...
	  	  if(envvalue==0)
	  		  val=17; 
			  Boolean r=driver.findElement(By.id("lines5")).isSelected();
			  System.out.println("bool : "+r);
				 
			  driver.findElement(By.cssSelector("div[id='collapseFeature5'] [class='switch enabled']")).click();
			  Thread.sleep(2000);
			  
			  driver.findElement(By.xpath(".//*[@id='collapseFeature5']/div[2]/form/div/button[2]")).click();
	  ...
	  public void turnOnOffSelectedCallLog(int featureOrder, String featureName,WebDriver driver, String br, int numSuspended,int tab,String[] tnSuspendedStatus)
	  {
	  	  Boolean onoff=driver.findElement(By.id("lines1")).isSelected();
	  	  String on="OFF";
	  	  String not="ON";
		  ...
		  if(tab==1)
		  {
		   if(driver.findElements(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div["+newcount+"]/div/label")).size() >0)
		   {
			  System.out.println("Here now1 check"+featureName+rand);
			  driver.findElement(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div["+newcount+"]/div/label")).click();
		   }
		   else
		   {
			  System.out.println("Here now2");
		   ...
		   if(validTns > 2){
		   if(driver.findElements(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div["+newcount1+"]/div/label")).size() >0)
		   {
			  System.out.println("Here now1 check"+featureName+rand1);
			  driver.findElement(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div["+newcount1+"]/div/label")).click();
		   }
		   else
		   {
			  System.out.println("Here now2");
			  ...
			  if(driver.findElements(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div["+newcount+"]/label")).size() >0)
			   {
				  System.out.println("Here now1 check"+featureName+rand);
				  driver.findElement(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div["+newcount+"]/label")).click();
			   }
			   else
			   {
				  System.out.println("Here now2");
			   ...
			   if(validTns > 2){
			   if(driver.findElements(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div["+newcount1+"]/label")).size() >0)
			   {
				  System.out.println("Here now1 check"+featureName+rand1);
				  driver.findElement(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div["+newcount1+"]/label")).click();
			   }
			   else
			   {
				  System.out.println("Here now2");
		  ...
		  int val=11;
	  	  if(envvalue==0)
	  		  val=17;
		  driver.findElement(By.xpath(".//*[@id='collapseFeature1']/div[2]/form/div["+val+"]/button[2]")).click();
	  ...
	  public void turnOnOffSelectedReturn69(int featureOrder, String featureName,WebDriver driver, String br, int numSuspended,int tab,String[] tnSuspendedStatus)
	  {
	  	  Boolean onoff=driver.findElement(By.id("lines2")).isSelected();
	  	  String on="OFF";
	  	  String not="ON";
		  ...
		  if(tab==1)
		  {
		   if(driver.findElements(By.xpath("//div[@id='collapseFeature2']/div[2]/form/div["+newcount+"]/div/label")).size() >0)
		   {
			  System.out.println("Here now1 check"+featureName+rand);
			  driver.findElement(By.xpath("//div[@id='collapseFeature2']/div[2]/form/div["+newcount+"]/div/label")).click();
		   }
		   else
		   {
			  System.out.println("Here now2");
		   ...
		   if(validTns > 2){
		   if(driver.findElements(By.xpath("//div[@id='collapseFeature2']/div[2]/form/div["+newcount1+"]/div/label")).size() >0)
		   {
			  System.out.println("Here now1 check"+featureName+rand1);
			  driver.findElement(By.xpath("//div[@id='collapseFeature2']/div[2]/form/div["+newcount1+"]/div/label")).click();
		   }
		   else
		   {
			  System.out.println("Here now2");
			  ...
			  if(driver.findElements(By.xpath("//div[@id='collapseFeature2']/div[2]/form/div["+newcount+"]/label")).size() >0)
			   {
				  System.out.println("Here now1 check"+featureName+rand);
				  driver.findElement(By.xpath("//div[@id='collapseFeature2']/div[2]/form/div["+newcount+"]/label")).click();
			   }
			   else
			   {
				  System.out.println("Here now2");
			   ...
			   if(validTns > 2){
			   if(driver.findElements(By.xpath("//div[@id='collapseFeature2']/div[2]/form/div["+newcount1+"]/label")).size() >0)
			   {
				  System.out.println("Here now1 check"+featureName+rand1);
				  driver.findElement(By.xpath("//div[@id='collapseFeature2']/div[2]/form/div["+newcount1+"]/label")).click();
			   }
			   else
			   {
				  System.out.println("Here now2");
	  ...
	  public void turnOnOffSelectedLastnumberRedial(int featureOrder, String featureName,WebDriver driver, String br, int numSuspended,int tab,String[] tnSuspendedStatus) throws InterruptedException
	  {
		  ...
		  if(tab==1)
		  {
		   if(driver.findElements(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div["+newcount+"]/div/label")).size() >0)
		   {
			  System.out.println("Here now1 check"+featureName+rand);
			  driver.findElement(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div["+newcount+"]/div/label")).click();
		   }
		   else
		   {
			  System.out.println("Here now2");
		   ...
		   if(validTns > 2){
		   if(driver.findElements(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div["+newcount1+"]/div/label")).size() >0)
		   {
			  System.out.println("Here now1 check"+featureName+rand1);
			  driver.findElement(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div["+newcount1+"]/div/label")).click();
		   }
		   else
		   {
			  System.out.println("Here now2");
			  ...
			  if(driver.findElements(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div["+newcount+"]/label")).size() >0)
			   {
				  System.out.println("Here now1 check"+featureName+rand);
				  driver.findElement(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div["+newcount+"]/label")).click();
			   }
			   else
			   {
				  System.out.println("Here now2");
			   ...
			   if(validTns > 2){
			   if(driver.findElements(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div["+newcount1+"]/label")).size() >0)
			   {
				  System.out.println("Here now1 check"+featureName+rand1);
				  driver.findElement(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div["+newcount1+"]/label")).click();
			   }
			   else
			   {
				  System.out.println("Here now2");
	 ...
	 if(focusSearch(driver,driver.findElement(By.xpath("//*[@id='collapseFeature"+(count)+"']/div[2]/form/div["+(5+j)+"]/div/i")),br))
	        {
	        ...
	        { 
	              System.out.println("tn2");
	               TN=driver.findElement(By.xpath("//*[@id='collapseFeature"+(count)+"']/div[2]/form/div["+(5+j)+"]/div/label")).getText();
	              break;
	        }
	        else
	        {
	              
	               driver.findElement(By.xpath("//*[@id='collapseFeature"+(count)+"']/div[2]/form/div["+(5+j)+"]/div/label")).click();
...
@SuppressWarnings("finally")
	...
	public void Unsavedpopup(String br, WebDriver driver, int featureOrder,int tab) throws InterruptedException
	  {
	...
	public void UnsavedpopupCallLog(String br, WebDriver driver, int featureOrder,int tab) throws InterruptedException
	  {
		  logger.info("Unsavedpopup");
		
		  //driver.findElement(By.xpath(xpath_ACRunsavedpopup_xpath1)).click();
		  if(tab==1)
			  driver.findElement(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div[4]/div/label")).click();
		  else			  
			  driver.findElement(By.xpath("//div[@id='collapseFeature1']/div[2]/form/div[4]/label")).click();
	...
	public void UnsavedpopupReturn69(String br, WebDriver driver, int featureOrder,int tab) throws InterruptedException
	  {
		  logger.info("Unsavedpopup");
	...
	public void UnsavedpopupLastnumberRedial(String br, WebDriver driver, int featureOrder,int tab) throws InterruptedException
	  {
		  ...
		  //driver.findElement(By.xpath(xpath_ACRunsavedpopup_xpath1)).click();
		  if(tab==1)
			  driver.findElement(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div[4]/div/label")).click();
		  else			  
			  driver.findElement(By.xpath("//div[@id='collapseFeature5']/div[2]/form/div[4]/label")).click();
	...
	public void CancelCallLog(String br,WebDriver driver, int featureOrder,int tab)
	  {
	      logger.info("Cancel");
	      if(tab==1)
	    	  driver.findElement(By.linkText("Incoming Calls")).click();
	      ...
	      driver.findElement(By.cssSelector("#collapseFeature1 > div.accordian-header > div.header-right")).click();
	      boolean b= driver.findElement(By.id("lines"+1)).isSelected();
	      ...
	      int val=11;
	  	  if(envvalue==0)
	  		  val=17;
	      driver.findElement(By.xpath(".//*[@id='collapseFeature1']/div[2]/form/div["+val+"]/button[1]")).click();
		  ...
		  if(driver.findElement(By.xpath(".//*[@id='collapseFeature1']/div[2]/form/div/button[2]")).isEnabled())
	...
	public void CancelReturn69(String br,WebDriver driver, int featureOrder,int tab)
	  {
	      logger.info("Cancel");
	      if(tab==1)
	    	  driver.findElement(By.linkText("Incoming Calls")).click();
	...
	public void CancelLastnumberRedial(String br,WebDriver driver, int featureOrder,int tab)
	  {
	      logger.info("Cancel");
	      if(tab==1)
	    	  driver.findElement(By.linkText("Incoming Calls")).click();
	      ...
	      driver.findElement(By.cssSelector("#collapseFeature5 > div.accordian-header > div.header-right")).click();
	      boolean b= driver.findElement(By.id("lines"+5)).isSelected();
	      ...
	      int val=11;
	  	  if(envvalue==0)
	  		  val=17;
	      driver.findElement(By.xpath(".//*[@id='collapseFeature5']/div[2]/form/div["+val+"]/button[1]")).click();
		  ...
		  if(driver.findElement(By.xpath(".//*[@id='collapseFeature5']/div[2]/form/div/button[2]")).isEnabled())
	      //if(b==driver.findElement(By.id("lines1")).isSelected())
		  {
	    	  logger.info("Fail");
	    	  statusTracker(br,"Fail","Verify if the user is able to cancel the changes made","Cancelling the order did not revert the changes made","Should be able to successfully cancel the order");
