...
public class GPSACR extends CommonFunctions
{
              ...
              String xpath_GPSexecute_xpath1;
          	  String ACRxpath_GPSexecute_newfeature;
          	  String ACRxpath_GPSexecute_save;
          	  String ACRxpath_GPSexecute_turnOnOff;
          	  String ACRxpath_GPSexecute_cancel;
  ...
  public void turnOnOffSelected(String feature,WebDriver driver, String br, int rowCount,int numSuspended,int tab,String[] tnSuspendedStatus,int divval)
  {
	...
	public void turnoffon(String br,WebDriver driver, String status1,int TN1,int divval,String feature)
	{
		...
		driver.findElement(By.xpath(ACRxpath_GPSexecute_save)).click();
	...
	public void Cancel(String br,WebDriver driver, String feature,int tab,int val) throws InterruptedException
	  {
	      ...
	      driver.findElement(By.xpath(ACRxpath_GPSexecute_cancel)).click();
	      		  
		  Thread.sleep(2000);
	      if(!(driver.findElement(By.xpath(ACRxpath_GPSexecute_cancel)).isEnabled()))
	      {
	    	  logger.info("Success");
	    	 // state="Pass";
  ...
  public void execute(String br, WebDriver driver,String url, int loc, String name1) throws Exception {
	  ...
	  ACRxpath_GPSexecute_newfeature = GPS.getProperty("ACRxpath_GPSexecute_newfeature");
	  ACRxpath_GPSexecute_save = GPS.getProperty("ACRxpath_GPSexecute_save");
	  ACRxpath_GPSexecute_turnOnOff = GPS.getProperty("ACRxpath_GPSexecute_turnOnOff");
	  ACRxpath_GPSexecute_cancel = GPS.getProperty("ACRxpath_GPSexecute_cancel");
			...
			try {
          		...
          		//focusClick(driver,driver.findElement(By.cssSelector("a[href='/TEST3/AdminMain/AdminCallSettings']")),br);
					...
					//size of list
						...
						int featureOrder=0;String feature="ACR";
						
						Actions actions = new Actions(driver);
						WebElement mainMenu = driver.findElement(By.xpath(".//*[@id='accordion_"+feature+"']/div"));
						actions.moveToElement(mainMenu);

						WebElement subMenu = driver.findElement(By.xpath(ACRxpath_GPSexecute_newfeature));
						actions.moveToElement(subMenu);
						actions.click().build().perform();
						
						if(driver.findElement(By.xpath(ACRxpath_GPSexecute_newfeature)).isDisplayed())
						{
						    System.out.println("Tooltip is coming up fine");
						    statusTracker(br,"","ACR Modal pop up is displayed",driver.findElement(By.xpath(ACRxpath_GPSexecute_newfeature)).getText(),"");						    
						 }
						else
						{
						...
						try
  	       				{
  	       					...
  	       					{
                              statusTracker(br,"","ACR Modal slides shows are displayed","","");
                              int pg1=0,pg2=0;
						...
						int rowCount=driver.findElements(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div[3]/table/tbody")).size();
						System.out.println("d: "+rowCount);

				    	tnSuspendedStatus=new String[rowCount];
				    	tnSuspendedStatus=suspendedStatus(rowCount,featureOrder, feature,driver,1);				    	  
						...
						turnOnOffSelected(feature,driver, br, rowCount, numberSuspended,1, tnSuspendedStatus,divval);
						
						TN1= Select_TN(driver,feature,rowCount,br,divval);		
						...
						if(TN1!= 0)
                        {
                            logger.info("print");
                            status1="On";
                            turnoffon(br,driver, status1,TN1,divval,feature); 
                            
                            turnoffon(br,driver, status1,TN1,divval,feature);
                        }
						
						Unsavedpopup(br,driver,feature,2,divval);
