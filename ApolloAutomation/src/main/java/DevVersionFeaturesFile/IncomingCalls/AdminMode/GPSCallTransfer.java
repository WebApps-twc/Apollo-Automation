...
public class GPSCallTransfer extends CommonFunctions
{
                String table, tns[];
  ...
  public GPSCallTransfer()
  {
  }
  
  public GPSCallTransfer(String path) {
		this.path = path;
	}
  ...
  public void execute(String br, WebDriver driver,String url, int loc, String name1) throws Exception {
    ...
    try
    {
      ...
      try {
    	  ...
    	  String featureName="Call Transfer";
    	 ...
    	 /* if(suspended)
        	  ...
        	  onoff=driver.findElement(By.id("lines"+2)).isSelected();
        	  if(onoff)
        		  System.out.println("Feature was ON");
        	  else
        		  System.out.println("Feature was OFF");
