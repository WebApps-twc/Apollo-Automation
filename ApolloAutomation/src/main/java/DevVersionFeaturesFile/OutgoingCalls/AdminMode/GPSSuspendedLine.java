...
public class GPSSuspendedLine extends CommonFunctions
{
                String table, tns[];
  ...
  public GPSSuspendedLine()
  {
  }
  
  public GPSSuspendedLine(String path) {
		this.path = path;
	}
  ...
  public void execute(String br, WebDriver driver,String url, int loc, String name1) throws Exception {
    ...
    try
    {
      ...
      try {
    	  ...
    	  String featureName="Suspended Line";
    	  int featureOrder=FeatureListIncoming(driver,count1,featureName);

    	  System.out.println("outttttttt");
    	  focusClick(driver,driver.findElement(By.cssSelector("#collapseFeature7 > div.accordian-header > div.header-right")),br); 
    	 ...
    	 // String lineStatus=driver.findElement(By.xpath("//div[@id='collapseFeature4']/div/div/div/h4")).getText();
    	  ...
    	  if(suspended)
              ...
              if(onoff)
        	  {
        		  ...
        		  turnOnOffSuspendedLine(featureOrder,driver,br,2);
        	  }
        	  else
        	  {
              ...
              turnOnOffSuspendedLine(featureOrder,featureName,driver,br, numberSuspended,2,tnSuspendedStatus);
        	  
              UnsavedpopupSuspendedLine(br,driver, featureOrder,2);
              CancelSuspendedLine(br,driver, featureOrder,2);
