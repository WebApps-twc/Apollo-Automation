...
public void turnOnOffSelected(String feature,WebDriver driver, String br, int numSuspended,int tab,int val)
  ...
  public void turnoff(WebDriver driver, String br, String acc,int val,int bval)
                {
                  ...
                  focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[1]/span[2]/label")),br);
                  
                  for(int i=1;i<100;i++){}

                  focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature_CF']/div[3]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div["+bval+"]/button[2]")),br);
                  int chk=0;
                  do{
                                  chk++;
                  }while(driver.findElement(By.cssSelector("img[alt='icon-loading.gif']")).isDisplayed());
  ...
  public String TNcheck(String ac, String acode,WebDriver driver, int check,String br,int val,int bval) throws Exception
  {
                ...
                int check1=check;
                         driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/input")).clear();
            driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/input")).sendKeys(ac);      
          
                if(check1==2)
                {                      
                 driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[3]/input")).clear();
                 driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[3]/input")).sendKeys(acode);
                }
                if(check1==3)
                {
                 ac=2+Acccode;
                 logger.info("ac"+ac);
                 driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/input")).clear();
                 driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/input")).sendKeys(acode);
                }
                                ...
                                if(!(InternalException(driver,br)))
                                  {
                                    ...
                                    if(!(InternalException(driver,br)))
                                    {
                                              ...
                                              Unsavedpopup(br,driver, divval,3);
                                              ...
                                              if(driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[3]/div/label")).getText().contains("OFF"))
                                                {                                                  
                                                    focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[3]/i")),br);
                                                    statusTracker(br,"","The CFB tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[3]/div[2]/div[2]")).getText(),"");                                                                                
                                                }
                                  
                                                    focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[5]/button")),br);
                                                                        
                                                int cnt=driver.findElements(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div")).size();
                                                System.out.println("cnt"+cnt);
                                                if(cnt==2)
                                                {
                                                                boolean status= driver.findElement(By.xpath("//div[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[1]/span[2]/label")).isSelected();
                                                                int a3=3;
                                                                String acc="No Account code";
                                                                if(status==true)
                                                                {                                       
                                                                turnoff(driver, br, acc, divval,2);
                                                                }
                                                                else
                                                                {
                                                                turnOn(driver, br,acc, divval,2);
                                                                }
                                                                logger.info("orderprocess is done");
                                      
                                                                EditTn(driver,br,divval,2);
                                        
                                                                TNValidation(driver,br,a3,divval,2);
                                                }
                                                else if(cnt>=3)
                                                {                                   
                                                                if(driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]")).getText().contains("Local Calls Only"))
                                                                {
                                                                                int a1=1;                                      
                                                                                focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/div/i")),br);
                                                                                statusTracker(br,"","The Verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/div/div/div[2]")).getText(),"");
                                                                                
                                                                                String acntcd= driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/div/input")).getAttribute("class");
                                                                                logger.info("acntcd is"+acntcd);
                                                                                if(acntcd.contains("not"))
                                                                                {
                                                                                                logger.info("check is");
                                                                                                statusTracker(br,"","The Account code is"+Acccode,"","");    
                                                                                                focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/div/label")),br);           
                                                                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[3]/input")).sendKeys(Acccode);
                                                                                }
                                                                                else
                                                                                {
                                                                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[3]/input")).clear();
                                                                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[3]/input")).sendKeys(Acccode);
                                                                                }
                                                                                logger.info("check is");
                                                                                ...
                                                                                TNValidation(driver,br,a1,divval,4);     
                                                                               }
                                                                           else
                                                                             {
                                                                                int a2=2;       
                                                                                focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/label/i")),br);
                                                                                statusTracker(br,"","The Non-verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/label/div/div[2]")).getText(),"");
                                                                                
                                                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/input")).clear();
                                                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/input")).sendKeys("8956325485");
                                                                                ...
                                                                                TNValidation(driver,br,a2,divval,3); 
                                                                                
                                                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/input")).clear();
								                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/input")).sendKeys("9193220001");
								                                                                                
								                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody[1]/tr[2]/td/div/div[2]/div/div[3]/button[1]")).click();
								                                                                  
								                                                Thread.sleep(2000);                                           
								                                                if(!(driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody[1]/tr[2]/td/div/div[2]/div/div[3]/button[1]")).isEnabled()))
								                                                {
								                                                  logger.info("Success");
								                                                 // state="Pass";
								                                                  statusTracker(br,"Pass","Verify if the user is able to cancel the changes made","Successfully be able to cancel order","Should be able to successfully cancel the order");
