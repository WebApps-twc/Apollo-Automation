...
public void turnOnOffSelected(String feature,WebDriver driver, String br, int numSuspended,int tab,int divval)
  ...
  public void EditTn(WebDriver driver, String br,int divval,String feature,int val) throws InterruptedException
  	{  
            	  ...
            	  focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeature_SequentialRing']/div[3]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[4]/div/ul/ul/li["+n+"]")),br);
                                    ...
                                    if(!(InternalException(driver,br)))
                                    {
                                    	...
                                    	{                                   
                                    		if(driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div[3]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]")).getText().contains("Local Calls Only"))
                                    		{
                                    			...
                                    			EditTn(driver,br,divval,feature,val);
