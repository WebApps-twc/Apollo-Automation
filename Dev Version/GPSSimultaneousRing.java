...
public void turnOnOffSelected(String feature,WebDriver driver, String br, int numSuspended,int tab,int divval)
  ...
  public void turnoff(WebDriver driver, String br, String acc,int divval, String feature,int val)
  	{
                  ...
                  driver.findElement(By.xpath(SiRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/input")).clear();
                  driver.findElement(By.xpath(SiRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/input")).sendKeys(phoneline+num);
  ...
  public void EditTn(WebDriver driver, String br,int divval,String feature,int val)
  	{  
                  ...
                  String num=randomNO(3333,6666);
                  driver.findElement(By.xpath(SiRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr["+a1+"]/td[2]/input")).clear();
                  driver.findElement(By.xpath(SiRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr["+a1+"]/td[2]/input")).sendKeys(phoneline+num);
                  for(int i=1;i<10;i++){}
                  }
                  focusClick(driver,driver.findElement(By.xpath(SiRxpath_GPSexecute_save1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/div[2]/button[2]")),br);
                  int chk=0;
  ...
  public String TNcheck(String ac, String acode,WebDriver driver, int check,String br,int divval,String feature,int val) throws Exception
  {
         	...
         	int check1=check;
         	driver.findElement(By.xpath(SiRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/input")).clear();
            driver.findElement(By.xpath(SiRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/input")).sendKeys(ac);      
          
         	if(check1==2)
         	{                      
                 driver.findElement(By.xpath(SiRxpath_GPSexecute_acccode+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[3]/input")).clear();
                 driver.findElement(By.xpath(SiRxpath_GPSexecute_acccode+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[3]/input")).sendKeys(acode);
         	}
         	if(check1==3)
         	{
                 ac=2+Acccode;
                 logger.info("ac"+ac);
                 driver.findElement(By.xpath(SiRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[3]/input")).clear();
                 driver.findElement(By.xpath(SiRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[3]/input")).sendKeys(acode);
         	}
                               ...
                               if(first==0)
                                  ...
                                  if(!(InternalException(driver,br)))
                                  {
                                    ...
                                    if(!(InternalException(driver,br)))
                                    {
                						...
                						WebElement subMenu = driver.findElement(By.xpath(SiRxpath_GPSexecute_newfeature));
                						actions.moveToElement(subMenu);
                						actions.click().build().perform();
                						
                						if(driver.findElement(By.xpath(SiRxpath_GPSexecute_newfeature)).isDisplayed())
                						{
                						    System.out.println("Tooltip is coming up fine");
                						    statusTracker(br,"","SimultaneousRing Ring Modal pop up is displayed",driver.findElement(By.xpath(SiRxpath_GPSexecute_newfeature)).getText(),"");						    
                						 }
                						else
                						{
                                    	...
                                    	{                                   
                                    		...
                                    		{
                                    			int a1=1,val=4;                                      
                                    			focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/div/div/i")),br);
                                    			...
                                    			String acntcd= driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/div/div/input")).getAttribute("class");
                                    			logger.info("acntcd is"+acntcd);
                                    			if(acntcd.contains("not"))
                                    			{
                                    				logger.info("check is");
                                    				statusTracker(br,"","The Account code is"+Acccode,"","");    
                                    				focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/div/div/label")),br);           
                                    				driver.findElement(By.xpath(SiRxpath_GPSexecute_acccode+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[3]/input")).sendKeys(Acccode);
                                    			}
                                    			else
                                    			{
                                    				driver.findElement(By.xpath(SiRxpath_GPSexecute_acccode+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[3]/input")).clear();
                                    ...
                                    else
                                    {
                            			...
                            			driver.findElement(By.xpath(SiRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[3]/input")).clear();
                            			driver.findElement(By.xpath(SiRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[3]/input")).sendKeys("8956325485");
                            			...
                            			driver.findElement(By.xpath(SiRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/input")).clear();
                                        driver.findElement(By.xpath(SiRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[1]/td[2]/input")).sendKeys("9193220001");
