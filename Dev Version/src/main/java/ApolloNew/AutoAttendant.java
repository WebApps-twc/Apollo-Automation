...
public class AutoAttendant extends CommonFunctions {
    ...
    {
 	   boolean stus=driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[1]")).isSelected();
	       ...
	       focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[1]/label")),br); 
	    	  ...
	    	  do{
	    		...
	    		if(driver.findElement(By.id("dataSaveSucess")).isDisplayed() )
	    		 ...
	    		 {
	    			statusTracker(br,"Fail","Verify order processing for AutoAttendant from "+ Frm +" to "+ To,"Order processing has failed"+driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[3]/div/div/ul")).getText(),"Order should be processed successfully");	
	    			Thread.sleep(1000);
	    			//schk="Fail";
	    		 }	
    }
    ...
    public void tunon(WebDriver driver,String br) throws Exception
    {
 	   ...
 	   boolean alwsstatus=driver.findElement(By.id("alwaysTime")).isSelected();
	    	...
	    	if(alwsstatus==true){
	  	    	  Frm1="Always";
	  	          To1="Specific times";
	  	        focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[4]/div[2]/label")),br); }
	  	    else{
	  	    	  Frm1="Specific times";
	  	    	  To1="Always";
	  	    	focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[4]/div[1]/label")),br); 
}	
	    	...
	    	focusClick(driver,driver.findElement(By.cssSelector("button.btn.btn-primary")),br); 
	    	  ...
	    	  do{
	    		...
	    		if(driver.findElement(By.id("dataSaveSucess")).isDisplayed() )
	    		 ...
	    		 {
	    			statusTracker(br,"Fail","Verify order processing for AutoAttendant from "+ Frm1 + " to " + To1,"Order processing has failed"+driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[3]/div/div/ul")).getText(),"Order should be processed successfully");	
	    			Thread.sleep(1000);
	    			//schk="Fail";
	    		 }
    }
    ...
    {
 	   String n1=n;
 	  focusDropdown(driver,".//*[@id='collapseFeature1']/div[2]/form/div[6]/span",n1,br);
 	  //focusClick(driver,driver.findElement(By.xpath("//html/body/section/div[4]/div[2]/form/div[6]/span/select/option["+n1+"]")),br); 
	    	...
	    	focusClick(driver,driver.findElement(By.cssSelector("button.btn.btn-primary")),br); 
	    	  ...
	    	  if(driver.findElement(By.id("dataSaveSucess")).isDisplayed() )
	    		 ...
	    		 {
	    			statusTracker(br,"Fail","Verify order processing for AutoAttendant for changing the Rings to " + n1,"Order processing has failed"+driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[3]/div/div/ul")).getText(),"Order should be processed successfully");	
	    			Thread.sleep(1000);
	    			//schk="Fail";
	    		 } 		    	  	    	  			    	
    }
    ...
    public void Errorvali(WebDriver driver,String br) throws Exception
    {
 	   ...
 	   int lst=driver.findElements(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div")).size();
 	   System.out.println("lst"+lst);
 	   if(lst>2)
 	   {
 		  focusClick(driver,driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[3]/div[2]/a")),br); 
 		   
 		   driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div/div[1]/input")).clear();
	    	   driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div/div[1]/input")).sendKeys("");
	    	   driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div/div[2]/input")).clear();
	    	   driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div/div[2]/input")).sendKeys("");
	    	   ...
	    	   focusClick(driver,driver.findElement(By.xpath("//div[@id='editModal']/div/div[2]/span[2]")),br); 
	            ...
	            if(driver.findElements(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[4]")).size()>0)
	            {
	            	statusTracker(br,"Pass","Verify if error message is displayed when adding TN with blank name","Error message is displayed: "+ driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[4]/div/div/ul")).getText(),"Error message should be displayed");		         		  
	            }
 		   ...
 		   for(int i=1;i<=2;i++)
 		   {
 			  focusClick(driver,driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div["+i+"]/div[3]/span")),br); 

 			  do{
			       }while(driver.findElement(By.cssSelector("div.modal-loading")).isDisplayed());
	             if(driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[4]")).isDisplayed() && val1>=0)
	             {
	            	statusTracker(br,"Pass","Verify if error message is displayed when deleting TN used in menu tree","Error message is displayed: "+ driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[4]/div/div/ul")).getText(),"Error message should be displayed");		         		  
	            	val1=1;
	             }
	             else if(val2>=0)
	             {
    ...
    public void MenuTree(WebDriver driver,String br) throws Exception
	  {
    	...
    	if(br.equals("IE"))	  
     	...
     	focusDropdown(driver,"//html/body/section/div[4]/div[2]/form/div[8]/div[1]/section/div[2]/div[2]/div[2]/div/span","4",br);
	       ...
	       {
	    	   	focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[1]/div[2]/div/span/select/option[2]")),br); 

	    	   int num1=driver.findElements(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[1]/div[4]/div/span/select/option")).size();
	    	   String num2=randomNO(1,num1);
	    	   focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[1]/div[4]/div/span/select/option["+num2+"]")),br); 
	    	    	   
	    	  focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[2]/div[2]/div/span/select/option[3]")),br); 
	    	  focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[3]/div[2]/div/span/select/option[4]")),br); 
	    	 focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[4]/div[2]/div/span/select/option[5]")),br); 
	    	   int nu1=driver.findElements(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[4]/div[4]/div/span/select/option")).size();
	    	   String nu2=randomNO(1,nu1);
	    	  focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[4]/div[4]/div/span/select/option["+nu2+"]")),br); 
	    	 focusClick(driver,driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[2]/form/div[8]/div[1]/section/div[2]/div[5]/div[2]/div/span/select/option[6]")),br); 
	       }	       	
     ...
     public void NmeDir(WebDriver driver,String br) throws Exception
      {
    	...
    	focusClick(driver,driver.findElement(By.linkText("Edit")),br);   	 
     	...
     	int n1=driver.findElements(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[2]/span/select/option")).size();
     	String num=randomNO(1,n1);
     	
     	if(n1>1)
     	{
     	//focusDropdown(driver,".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[2]/span",num,br);
     	//focusClick(driver,driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[2]/span/select/option["+num+"]")),br); 
         ...
         do{
	    		...
	    		if(driver.findElement(By.id("dataSaveSucess")).isDisplayed())
	    		 ...
	    		 {
	    			statusTracker(br,"Fail","Verify order processing for adding lines to memberlist","Order processing has failed"+driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[4]/div/div/ul")).getText(),"Order should be processed successfully");	
	    			Thread.sleep(1000);
	    			//schk="Fail";
	    		 }
	    		Thread.sleep(3000);
	    		...
	    		driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div/div[1]/input")).clear();
	    	    driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div/div[1]/input")).sendKeys("Office2");
	    	    driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div/div[2]/input")).clear();
	    	    driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/section/div[2]/div/div[2]/input")).sendKeys("Line1242");
	            ...
	            do{
		    		...
		    		if(driver.findElement(By.id("dataSaveSucess")).isDisplayed() )
		    		 ...
		    		 {
		    			statusTracker(br,"Fail","Verify order processing for Editing the memberlist names","Order processing has failed"+driver.findElement(By.xpath(".//*[@id='editModal']/div/div[1]/div[2]/div/form/div[4]/div/div/ul")).getText(),"Order should be processed successfully");	
		    			Thread.sleep(1000);
		    			//schk="Fail";
	  ...
	  public void execute(String br, WebDriver driver, String url, int loc, String name1) throws Exception {
		  ...
		  try
		  {
	  	    ...
	  	    if(!(InternalException(driver,br)))
            {
	  	      ...
	  	      String status = driver.findElement(By.xpath("//*[@id='collapseFeature1']/div[1]/div/div/h4")).getText();
