...
public class GPSLastNumberRedial extends CommonFunctions
{
                String table, tns[];
  ...
  public GPSLastNumberRedial()
  {
  }
  
  public GPSLastNumberRedial(String path) {
		this.path = path;
	}
  ...
  public void execute(String br, WebDriver driver,String url, int loc, String name1) throws Exception {
    ...
    try
    {
      ...
      try {
    	  ...
    	  String featureName="Last Number Redial";
