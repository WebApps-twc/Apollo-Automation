...
public class GPSSequentialRing extends CommonFunctions
{
  ...
  public GPSSequentialRing(String path, String file1, String file2) {
		this.path = path;
		this.path1 = file1;
		this.path2 = file2;
	}
  ...
  public void turnOnOffSelected(int featureOrder, String featureName,WebDriver driver, String br, int numSuspended,String[] tnSuspendedStatus)
  {
	  ...
	  if(validTns > 2)
	  	...
	  	System.out.println("data "+newcount+" "+newcount1);
	  	 String Featurename="{\"name\":\"SequentialRing_FeatureName\",\"value\":\"Sequential Ring\",\"parameters\":[],\"text\":\"Sequential Ring\",\"exampleText\":\"Sequential Ring\"}";
  ...
  public void Unsavedpopup(String br, WebDriver driver, int featureOrder)
  {
	  ...
	  focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeature"+featureOrder+"']/div[2]/form/div[5]/label")),br);	 
	  ...
	  if(CH==true)
	  {
		  ...
		  {
			  logger.info("Success");
			  statusTracker(br,"Pass","Verify if clicking on cancel navigating to Sequential Ring Page","Successfully navigate back to ACR Page on clicking cancel","Success");
		  }
	  }     
  ...
  public void Cancel(String br,WebDriver driver, int featureOrder)
  {
      logger.info("Cancel");    
      ...
      focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeature"+featureOrder+"']/div[2]/form/div[5]/label")),br);
      	...
      	focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature"+featureOrder+"']/div[2]/form/div[9]/button[1]")),br);
