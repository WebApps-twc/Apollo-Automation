...
public class GPSSimultaneousRing extends CommonFunctions
{
  ...
  public void turnOnOffSelected(int featureOrder, String featureName,WebDriver driver, String br, int numSuspended,String[] tnSuspendedStatus)
  {
	  ...
	  if(validTns > 2)
	  	...
	  	String Featurename="{\"name\":\"SimultaneousRing_FeatureName\",\"value\":\"Simultaneous Ring\",\"parameters\":[],\"text\":\"Simultaneous Ring\",\"exampleText\":\"Simultaneous Ring\"}";
  ...
  public void Unsavedpopup(String br, WebDriver driver, int featureOrder)
  {
	  ...
	  if(CH==true)
	  {
		  ...
		  {
			  logger.info("Success");
			  statusTracker(br,"Pass","Verify if clicking on cancel navigating to Simultaneous ring Page","Successfully navigate back to ACR Page on clicking cancel","Success");
		  }
	  }     
	  focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeature"+featureOrder+"']/div[2]/form/div[5]/label")),br);
