   ...
   public String crtgrup(WebDriver driver, int k1,String br) throws Exception
      ...
      int a = 0, a1=0, a2=0, k=k1, b=0, c=0, d=0;String type = null;
       ...
       logger.info("save123");
        ...
        if(driver.findElements(By.xpath("//*[@id='collapseFeature3']/div[2]/div[3]/div/div")).size()>0){      
       ...
       public void val(WebDriver driver,String br) throws Exception
       {
         ...
         do{
                    ...
                    if(driver.findElement(By.xpath("//*[@id='collapseFeature3']/div[2]/div[3]/div/div/ul")).isDisplayed())
                     {
                                   statusTracker(br,"Pass","Verify if error message is displayed while trying to create hunting without selecting the type","Error message is displayed: "+ driver.findElement(By.xpath("//*[@id='collapseFeature3']/div[2]/div[3]/div/div/ul")).getText(),"Error message should be displayed");
                                  //schk="Pass";
                     }
                     else
                      {
                  ...
                  focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature3']/div[2]/form/div[4]/button[2]")),br);
                    ...
                    if(driver.findElement(By.xpath("//*[@id='collapseFeature3']/div[2]/div[3]/div/div/ul")).isDisplayed())
                     {
                                   statusTracker(br,"Pass","Verify if error message is displayed while trying to create hunting without line","Error message is displayed: "+ driver.findElement(By.xpath("//*[@id='collapseFeature3']/div[2]/div[3]/div/div/ul")).getText(),"Error message should be displayed");
                                  //schk="Pass";
                     }
                     else
                    {
