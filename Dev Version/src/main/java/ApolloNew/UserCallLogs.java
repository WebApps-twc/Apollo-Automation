...
public class UserCallLogs extends CommonFunctions {
    ...
    String TNxpath=".//*[@id='collapseFeature1']/div[2]/form/div[5]";
	  ...
	  public void execute(String br, WebDriver driver, String url, int loc, String name1) throws Exception {
		  ...
		  try
		  {
	          ...
	          try {
	              ...
	              focusClick(driver,driver.findElement(By.xpath("//html/body/header/div[4]/div[2]/nav/ul/li[1]")),br);//loding admin Home
                  ...
                  focusClick(driver,driver.findElement(By.xpath("//html/body/section/div[2]/section/div/a[4]")),br);//takes to outgoing calls GCS

                  if(!(InternalException(driver,br)))
	              {
                	 focusClick(driver,driver.findElement(By.cssSelector("#collapseFeature1 > div.accordian-header > h3.ng-binding")),br); //clicking Calls Logs
                  ...
                  for(int j=1;j<10;j++){}
                  focusClick(driver,driver.findElement(By.xpath("//html/body/header/div[1]/a")),br);//going to user view

                  focusClick(driver,driver.findElement(By.xpath("//html/body/section/div[2]/section/div/a[1]")),br);//going to call logs and voicemails

                  if(driver.findElement(By.xpath("//html/body/section/div[6]/div/label/a")).isDisplayed())
                   {  
                	  logger.info("inside");
                	  ...
                	  else
                	   {
                		  ...
                		  {    ;              			                			  
                			  ...
                			  {             
                				  ...
                				  focusClick(driver,driver.findElement(By.xpath(".//*[@id='call-log-section']/div[3]/div/ul/li["+(3+jcnt)+"]/span")),br);
                				  jcnt++;
                			  }
                		  }
                		  focusClick(driver,driver.findElement(By.xpath("//html/body/section/div[8]/div[2]/span/select/option[2]")),br);//call Logs Recieved
                		  ...
                		  {                			                  		  
                		    ...
                		    if(size1>1)
                		    	...
                		    	int jcnt1=0;
                   		       ...
                   		       if(Sta.equals("Pass"))
                   			      statusTracker(br,"Pass","Verify if the Received Call Type only displayed"+driver.findElement(By.xpath("//html/body/section/div[8]/div[2]/span/select/option[2]")).getText(),"Able to see only the Received Call Type","Should be able to see only the Received Call Type");   
                   		       else
                   		          statusTracker(br,"Fail","Verify if the Received Call Type only displayed"+driver.findElement(By.xpath("//html/body/section/div[8]/div[2]/span/select/option[2]")).getText(),"Not Able to see only the Received Call Type","Should be able to see only the Received Call Type");                      		    	
                	         }
                		  }
                   	      Thread.sleep(2000);            
                   	   focusClick(driver,driver.findElement(By.xpath("//html/body/section/div[8]/div[2]/span/select/option[3]")),br);//Call Logs Missed
                		     ...
                		     if(size2>1)
                		    	 ...
                		    	 int jcnt2=0;
                   		        ...
                   		        {                           		        	
                   		    	  ...
                   		    	  if(j2%10==0)
                   			      {               				  
                   		    		focusClick(driver,driver.findElement(By.xpath("//*[@id='call-log-section']/div[3]/div/ul/li["+(3+jcnt2)+"]/span")),br);
                   				  jcnt2++;
                   			      }
                   		           ...
                   		           if(Sta1.equals("Pass"))
                   			         statusTracker(br,"Pass","Verify if the Missed Call Type only displayed"+ driver.findElement(By.xpath("//html/body/section/div[8]/div[2]/span/select/option[3]")).getText(),"Able to see only the Missed Call Type","Should be able to see only the Missed Call Type");   
                   		           else
                   		             statusTracker(br,"Fail","Verify if the Missed Call Type only displayed"+ driver.findElement(By.xpath("//html/body/section/div[8]/div[2]/span/select/option[3]")).getText(),"Not Able to see only the Missed Call Type","Should be able to see only the Missed Call Type");                      		    	
                	           }
                   	      }
                		  Thread.sleep(2000);  
                		  focusClick(driver,driver.findElement(By.xpath("//html/body/section/div[8]/div[2]/span/select/option[4]")),br);
                		  if(driver.findElement(By.xpath(".//*[@id='call-log-section']/div[2]")).getText().equals("There are no Call Logs to display at this time"))
                 	        {
