                      ...
                      logger.info("fetcnt"+fetcnt1);
                       if(fetcnt1>1)
                       {
                         ...
                         else
                        {
                          ...
                          focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature0']/div[9]/form/div[7]/button[1]")),br);
                       ...
                       boolean status=driver.findElement(By.id("toggleButton1")).isSelected();
                             ...
                             else
                            {
                              ...
                              statusTracker(br,"Fail","Verify order process for call scheduler from "+ from + " to "+ to,"The order is failed to process","Unable to process successfully");
                                       ...
                                       focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature0']/div[9]/form/div[7]/button[2]")),br);
                                       Thread.sleep(1000);
                                       focusClick(driver,driver.findElement(By.xpath(".//*[@id='deleteConfirmationModal']/div/div[2]/span[2]")),br);
