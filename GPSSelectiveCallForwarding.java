...
public class GPSSelectiveCallForwarding extends CommonFunctions
{
              ...
              String SCFxpath_GPSexecute_save1;
...
public void turnOnOffSelected(String feature,WebDriver driver, String br, int numSuspended,int tab,int divval)
  ...
  public void turnoff(WebDriver driver, String br, String acc,int val)
  	{
                  ...
                  focusClick(driver,driver.findElement(By.xpath(SCFxpath_GPSexecute_save1+"/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[3]/button[2]")),br);
                  int chk=0;
                  do{
                	  chk++;
                  }while(driver.findElement(By.cssSelector("img[alt='icon-loading.gif']")).isDisplayed());
  ...
  public void execute(String br, WebDriver driver,String url, int loc, String name1) throws Exception {
                  ...
                  SCFxpath_GPSexecute_save1 = GPS.getProperty("SCFxpath_GPSexecute_save1");
