...
public class Admin_CF extends CommonFunctions
{
 ...
 this.path = path;
  ...
  public void turnOnOff(String feature, WebDriver driver, String br,int tab,int val)
  {
		...
		driver.findElement(By.cssSelector("tr.ng-scope > td > button.btn.btn-primary")).click();
		...
		for(int j=1;j<rowCount;j++)
			{
				try
				{
					...
					else
					{
						...
						focusClick(driver,driver.findElement(By.cssSelector("tr.ng-scope > td > button.btn.btn-primary")),br);
                                ...
                                if(!(InternalException(driver,br)))
                                  {
                                    ...
                                    if(!(InternalException(driver,br)))
                                    {
                                    	...
                                    	TN1=Select_TN(driver,"CF",numberOfTns,br,2,divval);
                                    	...
                                    	int cnt=driver.findElements(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div")).size();
                                    	System.out.println("cnt"+cnt);
                                    	if(cnt==2)
                                    	{
                                    		boolean status= driver.findElement(By.xpath("//div[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[1]/span[2]/label/span")).isSelected();
                                    		int a3=3;
                                    	...
                                    	{                                   
                                    		if(driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[2]")).getText().contains("Local Calls Only"))
                                    		{
                                    			int a1=1;                                      
