...
public class GPSDoNotDisturb extends CommonFunctions
{
  ...
  public void turnOnOff(String feature, WebDriver driver, String br,int tab,int val) throws InterruptedException      
  {
				...
				if(!(InternalException(driver,br)))
				{
					...
					if(!(InternalException(driver,br)))
					{
						...
						if(driver.findElement(By.xpath(".//*[@id='newFeature_"+featureName+"']/div[2]")).isDisplayed())
						{
						    ...
						    statusTracker(br,"","DND Modal pop up is displayed",driver.findElement(By.xpath(".//*[@id='newFeature_"+featureName+"']/div[2]")).getText(),"");						    
						 }
						else
						{
