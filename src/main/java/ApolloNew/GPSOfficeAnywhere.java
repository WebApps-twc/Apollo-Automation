...
public class GPSOfficeAnywhere extends CommonFunctions
{
  ...
  /*public int FeatureListIncoming(WebDriver driver,int count1, String featureName)
  {
	  ...
	  for(int i=0;i<=count1;i++)
	  {
		  ...
		  if(driver.findElements(By.id("collapseFeature"+i)).size()>0)
		  {
    			  ...
    			  if(driver.findElement(By.id("collapseFeature"+i)).getAttribute("ng-repeat").contains("mobilityCall") || !(driver.findElement(By.id("collapseFeature"+i)).getAttribute("ng-if").contains("==")))
    			  {
  ...
  public void turnOnOffSelected(int featureOrder, String featureName,WebDriver driver, String br, int numSuspended,String[] tnSuspendedStatus)
  {
	  ...
	  if(validTns > 2)
	  	...
	  	String Featurename="{\"name\":\"RemoteOffice_FeatureName\",\"value\":\"Office Anywhere\",\"parameters\":[],\"text\":\"Office Anywhere\",\"exampleText\":\"Office Anywhere\"}";
