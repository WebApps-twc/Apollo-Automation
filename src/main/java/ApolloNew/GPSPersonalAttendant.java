...
public class GPSPersonalAttendant extends CommonFunctions
{
                String table, tns[];
  ...
  public GPSPersonalAttendant()
  {
  }
  
  public GPSPersonalAttendant(String path) {
		this.path = path;
	}
  ...
  public void turnOnOffSelected(int featureOrder, String featureName,WebDriver driver, String br, int numSuspended,String[] tnSuspendedStatus)
  {
	  ...
	  if(validTns > 2)
	  	...
	  	String Featurename="{\"name\":\"PersonalAnswering_FeatureName\",\"value\":\"Personal Attendant\",\"parameters\":[],\"text\":\"Personal Attendant\",\"exampleText\":\"Personal Attendant\"}";
  ...
  public void Unsavedpopup(String br, WebDriver driver, int featureOrder)
  {
	  ...
	  if(CH==true)
	  {
		  ...
		  {
			  logger.info("Success");
			  statusTracker(br,"Pass","Verify if clicking on cancel navigating to Personal Attendant Page","Successfully navigate back to ACR Page on clicking cancel","Success");
		  }
	  }     
  ...
  public void execute(String br, WebDriver driver,String url, int loc, String name1) throws Exception {
    ...
    try
    {
      ...
      try {
    	  ...
    	  String featureName="Personal Attendant";
