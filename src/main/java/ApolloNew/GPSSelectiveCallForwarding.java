...
public class GPSSelectiveCallForwarding extends CommonFunctions
{
  ...
  {
	  		String onoff=driver.findElement(By.xpath("//*[@id='collapseFeatureSCF']/div["+val+"]/table/thead/tr/th[2]/div/input")).getAttribute("class");
	  		System.out.println(onoff);
	  		String on="ON";
	  		String not="OFF";
	  		if(onoff.contains("not"))
	  		{
	  			String Selected=driver.findElement(By.xpath("//*[@id='collapseFeatureSCF']/div["+val+"]/table/thead/tr/th[2]/div")).getAttribute("class"); 
		...
		driver.findElement(By.xpath("//div[@id='collapseFeature"+feature+"']/div["+val+"]/table/thead/tr/th["+tab+"]/div/label")).click();
		
		focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature"+feature+"']/div[3]/table/tfoot/tr/td/button[2]")),br);
...
public void turnOnOffSelected(String feature,WebDriver driver, String br, int numSuspended,int tab,int val)
  {
	  	 int rowCount=driver.findElements(By.xpath("//*[@id='collapseFeature"+feature+"']/div["+val+"]/table/tbody")).size();
		 ...
		 rand1=Integer.parseInt(randomNO(1,rowCount-1));
		  ...
		  if(validTns > 2)
		   ...
		   if(driver.findElements(By.xpath("//*[@id='collapseFeature"+feature+"']/div["+val+"]/table/tbody["+rand+"]/tr[1]/td["+tab+"]/div/label")).size() >0)			
		   {			    
			driver.findElement(By.xpath("//*[@id='collapseFeature"+feature+"']/div["+val+"]/table/tbody["+rand+"]/tr[1]/td["+tab+"]/div/label")).click();			
		   }
		   ...
		   if(validTns > 2)
		   {
		    if(driver.findElements(By.xpath("//*[@id='collapseFeature"+feature+"']/div["+val+"]/table/tbody["+newcount1+"]/tr[1]/td["+tab+"]/div/label")).size() >0)			 
		     {			  
			  driver.findElement(By.xpath("//*[@id='collapseFeature"+feature+"']/div["+val+"]/table/tbody["+newcount1+"]/tr[1]/td["+tab+"]/div/label")).click();		   
		     }		  
		   }
  ...
  public String[] suspendedStatus(int numberOfTns,String feature, WebDriver driver,int val)
  {
	  ...
	  for(int i=1;i<=numberOfTns;i++)
	  {
			  ...
			  if(driver.findElement(By.xpath("//*[@id='collapseFeature"+feature+"']/div["+val+"]/table/tbody["+i+"]/tr[1]/td[1]/i")).isDisplayed())
  ...
  public void Unsavedpopup(String br, WebDriver driver, int val,int tab) throws InterruptedException
  {
	  ...
	  driver.findElement(By.xpath("//*[@id='collapseFeatureSCF']/div["+val+"]/table/thead/tr/th["+tab+"]/div/label")).click();
  ...
  {                                                  
      focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeature"+feature+"']/div["+val+"]/table/thead/tr/th["+tab+"]/div/label")),br);
    	
      driver.findElement(By.xpath(".//*[@id='collapseFeature"+feature+"']/div["+val+"]/table/tfoot/tr/td/button[1]")).click();
      		  
	  Thread.sleep(2000);
      if(driver.findElement(By.xpath(".//*[@id='collapseFeature"+feature+"']/div["+val+"]/table/tfoot/tr/td/button[1]")).getAttribute("disabled").equals("disabled"))
      {
    	  logger.info("Success");
    	 // state="Pass";
  ...
  public void turnoff(WebDriver driver, String br, String acc,int val)
  	{
                  String initialstate="On", chngetostate="Off", accst=acc;
                  
                  int tnlst=driver.findElements(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/table/tbody[1]/tr[2]/td/div/div[2]/div/div[2]/div/div")).size();
              	  System.out.println("tnlst"+tnlst);
              	  
              	  if(tnlst<=1)
              	  {
              		String num=randomNO(3333,6666);
              		driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/div/div/input")).clear();
                    driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/div/div/input")).sendKeys(phoneline+num);
                    focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/table/tbody[1]/tr[2]/td/div/div[2]/div/div[2]/div/div/span/button")),br);
              	  }

                  focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[1]/span[3]/label")),br);
                  
                  for(int i=1;i<100;i++){}

                  focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[3]/button[2]")),br);
                  int chk=0;
                  do{
                	  chk++;
                  }while(driver.findElement(By.cssSelector("img[alt='icon-loading.gif']")).isDisplayed());
                  ...
                  focusClick(driver,driver.findElement(By.xpath("//div[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[1]/span[3]/label")),br);
                  String num=randomNO(3333,6666);
                  driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[2]/div/input")).clear();
                  driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[2]/div/input")).sendKeys(phoneline+num);
  ...
  public void turnOn(WebDriver driver, String br, String acc, int val)
  	{
  ...
  public void DeltTn(WebDriver driver,String br, int val)
  {
	  int tnlst=driver.findElements(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/table/tbody[1]/tr[2]/td/div/div[2]/div/div[2]/div/div")).size();
  	  ...
  	  if(tnlst>2)
  	  {
  		tnlst=driver.findElements(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/table/tbody[1]/tr[2]/td/div/div[2]/div/div[2]/div/div")).size();
	  	    System.out.println("tnlst"+tnlst);
	  	    
	  	    focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/table/tbody[1]/tr[2]/td/div/div[2]/div/div[2]/div/div[2]/span/button")),br);
		...
		int tnlst1=driver.findElements(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/table/tbody[1]/tr[2]/td/div/div[2]/div/div[2]/div/div")).size();
  	    System.out.println("tnlst"+tnlst);
  ...
  public String TNcheck(String ac, String acode,WebDriver driver, int check,String br,int val) throws Exception
  {
         	...
         	int check1=check;
         	driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[2]/div/input")).clear();
            driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[2]/div/input")).sendKeys(ac);      
          
         	if(check1==2)
         	{                      
                 driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[4]/input")).clear();
                 driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[4]/input")).sendKeys(acode);
         	}
         	if(check1==3)
         	{
                 ac=2+Acccode;
                 logger.info("ac"+ac);
                 driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[3]/input")).clear();
                 driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[3]/input")).sendKeys(acode);
         	}
                                ...
                                if(!(InternalException(driver,br)))
                                  {
                                    ...
                                    {    
                						...
                						WebElement mainMenu = driver.findElement(By.xpath(".//*[@id='accordion_SCF']/div"));
                						actions.moveToElement(mainMenu);
                						                                                  
                						WebElement subMenu = driver.findElement(By.xpath(".//*[@id='newFeature_SCF']/div[2]"));
                						actions.moveToElement(subMenu);
                						actions.click().build().perform();
                						
                						if(driver.findElement(By.xpath(".//*[@id='newFeature_SCF']/div[2]")).isDisplayed())
                						{
                						    System.out.println("Tooltip is coming up fine");
                						    statusTracker(br,"","SCF Modal pop up is displayed",driver.findElement(By.xpath(".//*[@id='newFeature_SCF']/div[2]")).getText(),"");						    
                						 }
                						else
                						{
                                    	...
                                    	try
                                    	{
                                    		if(driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/div/h2")).isDisplayed())
                                    		{
                                                  ...
                                                  int pg1=0,pg2=0;
                                                  driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/div/div/div[2]/a[2]")).click();
                                                  if(driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/div/div/div[2]/a[2]")).getAttribute("class").equals("active"))
                                                	  pg1=1;
                                                  
                                                  driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/div/div/div[2]/a[1]")).click();
                                                  if(driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/div/div/div[2]/a[1]")).getAttribute("class").equals("active"))
                                                	  pg2=1;
                                                  ...
                                                  driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/div/button")).click();
                                                  Thread.sleep(1000);
                                                  if(driver.findElements(By.xpath(".//*[@id='collapseFeatureSCF']/div[3]/div/h2")).size()>0)
                                          		  {
                                    	...
                                    	turnOnOff("SCF",driver,br,2,divval);
                                    	
                                    	turnOnOff("SCF",driver,br,2,divval);
                                    	
                                    	turnOnOffSelected("SCF",driver,br,numberSuspended,2,divval);
                                    	
                                    	Unsavedpopup(br,driver, divval,2);
                                    	
                                    	Cancel(br,driver,"SCF",2,divval);
                                  
                                    	TN1=Select_TN(driver,"SCF",numberOfTns,br,2,divval);
                                    	System.out.println("TN1"+TN1);
                                    	phoneline1=driver.findElement(org.openqa.selenium.By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[1]")).getText();
                                    	phoneline=phoneline1.substring(0, 8);
                                    	System.out.println("phoneline"+phoneline);
                                    	
                                    	statusTracker(br,"","The SCF Phone number is",driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[3]/span")).getText(),"");	                                    		
                                    	...
                                    	{                                   
                                    		if(driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[3]")).getText().contains("Local Calls Only"))
                                    		{
                                    			...
                                    			if(acntcd.contains("not"))
                                    			{
                                    				...
                                    				driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[4]/input")).sendKeys(Acccode);
                                    			}
                                    			else
                                    			{
                                    				driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[4]/input")).clear();
                                    				driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[4]/input")).sendKeys(Acccode);
                                    			}
                                    			logger.info("check is");
                                    		...
                                    		else
                                    		{
                                    			...
                                    			driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[3]/input")).clear();
                                    			driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[1]/div/div[3]/input")).sendKeys("8956325485");
                                    	...
                                    	driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/div/div/input")).clear();
                                        driver.findElement(By.xpath(".//*[@id='collapseFeatureSCF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[2]/div/div[2]/div/div/input")).sendKeys("9193220001");
