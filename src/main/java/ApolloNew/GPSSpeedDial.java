...
public class GPSSpeedDial extends CommonFunctions
{
  ...
  {
	  	String onoff=driver.findElement(By.xpath("//*[@id='collapseFeature_SC1D']/div["+val+"]/table/thead/tr/th[2]/div/input")).getAttribute("class");
		System.out.println(onoff);
		String on="ON";
		String not="OFF";
		if(onoff.contains("not"))
		{
			String Selected=driver.findElement(By.xpath("//*[@id='collapseFeature_SC1D']/div["+val+"]/table/thead/tr/th[2]/div")).getAttribute("class"); 
  ...
  public void Unsavedpopup(String br, WebDriver driver, int val,int tab) throws InterruptedException
  {
	  ...
	  driver.findElement(By.xpath("//*[@id='collapseFeature_SC1D']/div["+val+"]/table/thead/tr/th["+tab+"]/div/label")).click();
  ...
  public int Select_TN(WebDriver driver,String featureName,int rowCount,String br,int tab,int val)
  	...
  	public void turnon(WebDriver driver, String br, String acc, int val)
	{
        ...
        driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[2]/input")).clear();
        driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[2]/input")).sendKeys(phoneline+num);
        for(int i=1;i<100;i++){}

        focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/table/tbody[1]/tr[2]/td/div/div/div/button[2]")),br);
        int chk=0;
        do{
      	  chk++;
        }while(driver.findElement(By.cssSelector("img[alt='icon-loading.gif']")).isDisplayed());
  	...
  	public void EditTn(WebDriver driver, String br, String acc, int val)
	{
  		String initialstate="Off", chngetostate="On",accst=acc; 
  		String num=randomNO(3333,6666);
        driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[2]/input")).clear();
  	...
  	public String TNcheck(String ac, String acode,WebDriver driver, int check,String br,int val) throws Exception
    {
           	...
           	int check1=check;
           	driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[2]/input")).clear();
            driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[2]/input")).sendKeys(ac);      
            
           	if(check1==2)
           	{                      
                   driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[4]/input")).clear();
                   driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[4]/input")).sendKeys(acode);
           	}
           	if(check1==3)
           	{
                   ac=2+Acccode;
                   logger.info("ac"+ac);                                                                     
                   driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[3]/input")).clear();
                   driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+val+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[3]/input")).sendKeys(acode);
           	}

           	focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/table/tbody[1]/tr[2]/td/div/div/div/button[2]")),br);
                             	                                
           	if(driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+val+"]/div[3]/div[2]/div/div/ul/li")).isDisplayed())
           	{
           		statusTracker(br,"Pass","Verify if error message is displayed when adding "+ac+" TN/Acc code","Error message is displayed: "+ driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+val+"]/div[3]/div[2]/div/div/ul/li")).getText(),"Error message should be displayed");
                  schk="Pass";
              }
              else
              {
  	 ...
  	 public String TNValidation(WebDriver driver, String br, int a, int val) throws Exception
  	  {
  	         ...
  	         if(a==1)
  	         {
  	        	 ...
  	        	 schk=TNcheck("919322","2",driver,2,br,val);
  	        	 String ac=2+Acccode;
  	         ...
  	         else if(a==2)
  	         {
  	        	 ...
  	        	 schk=TNcheck("919322","2",driver,3,br,val);
  	         }
			...
			try {
				...
				if(!(InternalException(driver,br)))
				{
					...
					if(!(InternalException(driver,br)))
					{
						...
						WebElement mainMenu = driver.findElement(By.xpath(".//*[@id='accordion_SC1D']/div"));
						actions.moveToElement(mainMenu);

						WebElement subMenu = driver.findElement(By.xpath(".//*[@id='newFeature_SD']/div[2]"));
						actions.moveToElement(subMenu);
						actions.click().build().perform();
						
						if(driver.findElement(By.xpath(".//*[@id='newFeature_SD']/div[2]")).isDisplayed())
						{
						    System.out.println("Tooltip is coming up fine");
						    statusTracker(br,"","SpeedDial Modal pop up is displayed",driver.findElement(By.xpath(".//*[@id='newFeature_SD']/div[2]")).getText(),"");						    
						 }
						else
						{
                    	...
                    	try
                    	{
                    		if(driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/div/h2")).isDisplayed())
                    		{
                                  ...
                                  driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/div/div/div[2]/a[2]")).click();
                                  if(driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/div/div/div[2]/a[2]")).getAttribute("class").equals("active"))
                                	  pg1=1;
                                  
                                  driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/div/div/div[2]/a[3]")).click();
                                  if(driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/div/div/div[2]/a[3]")).getAttribute("class").equals("active"))
                                	  pg2=1;
                                  
                                  driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/div/div/div[2]/a[1]")).click();
                                  if(driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div[3]/div/div/div[2]/a[1]")).getAttribute("class").equals("active"))
                                	  pg0=1;
                    	...
                    	int numberOfTns=driver.findElements(By.xpath("//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody")).size();                                  
                    	...
                    	turnOnOff("SC1D",driver,br,2,divval);
                    	
                    	turnOnOff("SC1D",driver,br,2,divval);
                    	
                    	turnOnOffSelected("SC1D",driver,br,numberSuspended,2,divval);
                    	
                    	Unsavedpopup(br,driver, divval,2);
                    	
                    	TN1=Select_TN(driver,"SC1D",numberOfTns,br,2,divval);
                    	System.out.println("TN1"+TN1);
                    	phoneline1=driver.findElement(org.openqa.selenium.By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[1]")).getText();
                    	phoneline=phoneline1.substring(0, 8);
                    	System.out.println("phoneline"+phoneline);
                    	
                    	focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[4]/button")),br);
                        
                    	int cnt=driver.findElements(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody[1]/tr[2]/td/div/div/table/tbody/tr[1]/td")).size();
                    	...
                    	if(cnt==3)
                    	{
                    		...
                    		String Stus=driver.findElement(org.openqa.selenium.By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[2]/div/label")).getText();
                    	...
                    	{                                    
                    		if(driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[3]")).getText().contains("Local Calls Only"))
                    		{
                    			int a1=1;                                      
                    			focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[3]/div/div/i")),br);
                    			...
                    			String acntcd= driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[3]/div/div/input")).getAttribute("class");
                    			logger.info("acntcd is"+acntcd);
                    			if(acntcd.contains("not"))
                    			{
                    				logger.info("check is");
                    				statusTracker(br,"","The Account code is"+Acccode,"","");    
                    				focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[3]/div/div/label")),br);           
                    				driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[4]/input")).sendKeys(Acccode);
                    			}
                    			else
                    			{
                    				driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[4]/input")).clear();
                    				driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[4]/input")).sendKeys(Acccode);
                    			}
                    			logger.info("check is");
                    		...
                    		{
                    			int a2=2;       
                    			focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/thead/tr/th[3]/i")),br);
                        		statusTracker(br,"","The Non-verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/thead/tr/th[3]/div/div[2]")).getText(),"");
                    			
                    			driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[3]/input")).clear();
                    			driver.findElement(By.xpath(".//*[@id='collapseFeature_SC1D']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/table/tbody/tr[1]/td[3]/input")).sendKeys("8956325485");
