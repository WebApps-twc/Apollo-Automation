...
public class UserSelectiveCallRejection extends CommonFunctions {
    ...
    String phoneline,phoneline_ac,Acccode,frntn;
                ...
                public String turnoff(WebDriver driver, String status,String br) throws InterruptedException
                  {
          ...
          public void EditTn(WebDriver driver,String br) throws InterruptedException
            {
                int cnt;String cnxpath;
                if(driver.findElement(By.xpath("//html/body/section/div[6]/div[1]/h3")).getText().equals("Custom Ring"))
                {
                  cnt=driver.findElements(By.xpath("//html/body/section/div[9]/div[2]/form/section/label")).size();
                   cnxpath="//html/body/section/div[9]/div[2]/form/div[2]/button[1]";
                }
                else
                {
                  cnt=driver.findElements(By.xpath("//html/body/section/div[8]/div[2]/form/section/label")).size();
                  cnxpath="//html/body/section/div[8]/div[2]/form/div[2]/button[1]";
                }
                Thread.sleep(1000);
                focusClick(driver,driver.findElement(By.xpath(cnxpath)),br);
                Thread.sleep(1000);
         ...
         public void maxTN(WebDriver driver,String br) throws Exception
        	 	...
        	 	String cnxpath;
                  ...
                  private Predicate<WebDriver> presenceOfElementLocated(By id) {
