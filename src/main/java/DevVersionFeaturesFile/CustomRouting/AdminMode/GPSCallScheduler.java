package DevVersionFeaturesFile.CustomRouting.AdminMode;
...
public class GPSCallScheduler extends CommonFunctions
{
                String table, tns[];
              ...
              String xpath_GPSexecute_xpath1;
          	  ...
          	  String xpath_GPSexecute_xpath3;
                
  public GPSCallScheduler()
  {
  }
  
  public GPSCallScheduler(String path) {
		this.path = path;
	}
  ...
  public void turnOnOff(int featureOrder, WebDriver driver, String br)
  {
		  ...
		  focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature"+featureOrder+"']/div[2]/form/div[5]/label")),br);
 ...
 if(driver.findElements(By.xpath("//div[@id='collapseFeature"+featureOrder+"']/div[2]/form/div["+newcount+"]/label")).size() >0)
	   ...
	   else
	   {
		  ...
		  focusClick(driver,driver.findElement(By.id("check"+rand1)),br);
	   }
  ...
  public void Cancel(String br,WebDriver driver, int featureOrder) throws InterruptedException
  {
      logger.info("Cancel");
     Thread.sleep(2000);
     focusClick(driver,driver.findElement(By.linkText("Custom Routing")),br);

      focusClick(driver,driver.findElement(By.cssSelector("#collapseFeature"+featureOrder+" > div.accordian-header > div.header-right")),br);
      boolean b= driver.findElement(By.id("lines1")).isSelected();
      
      focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature"+featureOrder+"']/div[2]/form/div[5]/label")),br);

      	focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature2']/div[2]/form/div[12]/button[1]")),br);
  ...
  public void execute(String br, WebDriver driver,String url, int loc, String name1) throws Exception {
	  ...
	  xpath_GPSexecute_xpath3 = GPS.getProperty("xpath_GPSexecute_xpath3");
    ...
    try
    {
      ...
      try {
    	  ...
    	  focusClick(driver,driver.findElement(By.xpath(xpath_GPSexecute_xpath3)),br);
    	  ...
    	  int featureOrder=2;//FeatureListIncoming(driver,count1,featureName);
    	  ...
    	  if(suspended)
        	  ...
        	  onoff=driver.findElement(By.id("lines1")).isSelected();
        	  if(onoff)
        		  System.out.println("Feature was ON");
        	  else
        		  System.out.println("Feature was OFF");
