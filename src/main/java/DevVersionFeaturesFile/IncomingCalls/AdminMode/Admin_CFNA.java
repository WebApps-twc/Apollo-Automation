...
public class Admin_CFNA extends CommonFunctions
{
                String table, tns[];
                String tlimit,username,pwd;
                String Acccode,phoneline,phoneline1;
                int rowCount,TN1, drpval, bval=3;
...
public void turnOnOffSelected(String feature,WebDriver driver, String br, int numSuspended,int tab,int divval)
					...
					for(int j=1;j<rowCount;j++)
					                {
			                                try
			                                {
                                                ...
                                                else if(driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+j+"]/tr[1]/td["+tab+"]/div/input")).getAttribute("class").contains("not"))
                                                { 
  ...
  public void numrngs(WebDriver driver,String br,int TN1,int drpval,int val1) throws Exception
  {
  ...
  public String TNcheck(String ac, String acode,WebDriver driver, int check,String br,int divval,String feature,int val) throws Exception
  {
            ...
            driver.findElement(By.xpath(CFxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div["+bval+"]/div/input")).sendKeys(ac);      
               ...
               focusClick(driver,driver.findElement(By.xpath(CFxpath_GPSexecute_save1+"/tbody["+TN1+"]/tr[2]/td/div/div["+bval+"]/div/div["+val1+"]/button[2]")),br);
                ...
                {
                 statusTracker(br,"Pass","Verify if error message is displayed when adding "+ac+" TN/Acc code","Error message is displayed: "+ driver.findElement(By.xpath(".//*[@id='collapseFeature_CF']/div["+divval+"]/div/div/div/ul/li")).getText(),"Error message should be displayed");
                schk="Pass";
                 }
            else
            {
                               ...
                               if(first==0)
                                  ...
                                  System.out.println("a");
                                    ...
                                    System.out.println("checkpoint1");
                                       ...
                                       Unsavedpopup(br,driver, divval,4,"CF");
                                        Cancel(br,driver,"CF",4,divval);
                          
                                        TN1=Select_TN(driver,"CF",numberOfTns,br,4,divval);
                                       ...
                                       phoneline1=driver.findElement(org.openqa.selenium.By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[1]")).getText();
                                        ...
                                        System.out.println("phoneline"+phoneline);
                                              ...
                                              if(driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[4]/div/label")).getText().contains("OFF"))
                                                {                                                  
                                                    focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[4]/i")),br);
                                                    statusTracker(br,"","The CFNA tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[4]/div[2]/div[2]")).getText(),"");                                                                                
                                                }
                                                ...
                                                {     drpval=2;
                                                                ...
                                                                TNValidation(driver,br,a3,divval,feature,3);
                                                }
                                                else if(cnt>=4)
                                                {                                   
                                                                if(driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div["+bval+"]/div/div[2]")).getText().contains("Local Calls Only"))
                                                                {
                                                                                ...
                                                                                statusTracker(br,"","The Verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[3]/div/div[2]/div/div/div[2]")).getText(),"");
                                                                                ...
                                                                                if(status==true)
                                                                                {
                                                                                turnoff(driver, br, acc, divval,feature,5);
                                                                                }
                                                                                else
                                                                                {
                                                                                 turnOn(driver, br,acc, divval,feature,5);
                                                                                }
                                                                                logger.info("orderprocess is done");                       
                                                                                EditTn(driver,br,divval,feature,5);
                                                                                numrngs(driver, br,TN1, drpval,5);
                                                                               TNValidation(driver,br,a1,divval,feature,5);     
                                                                               }
                                                                           else
                                                                              {
                                                                                int a2=2;  
                                                                                drpval=3;
                                                                                focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div[3]/div/div[2]/label/i")),br);
                                                                               ...
                                                                               TNValidation(driver,br,a2,divval,feature,4); 
                                                                                
                                                                                driver.findElement(By.xpath(CFxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div["+bval+"]/div/input")).clear();
								                                                driver.findElement(By.xpath(CFxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div["+bval+"]/div/input")).sendKeys("9193220001");
								                                                                                
								                                                driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody[1]/tr[2]/td/div/div[3]/div/div[3]/button[1]")).click();
								                                                                  
								                                                Thread.sleep(2000);                                           
								                                                if(!(driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody[1]/tr[2]/td/div/div[3]/div/div[3]/button[1]")).isEnabled()))
								                                                {
								                                                  logger.info("Success");
								                                                 // state="Pass";
								                                                  statusTracker(br,"Pass","Verify if the user is able to cancel the changes made","Successfully be able to cancel order","Should be able to successfully cancel the order");
