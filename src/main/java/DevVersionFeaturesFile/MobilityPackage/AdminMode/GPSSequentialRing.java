package DevVersionFeaturesFile.MobilityPackage.AdminMode;
...
public class GPSSequentialRing extends CommonFunctions
{
                String table, tns[];
                ...
                String SeRxpath_GPSexecute_newfeature;
                String SeRxpath_GPSexecute_turnOnOff;
                String SeRxpath_GPSexecute_save;
                String SeRxpath_GPSexecute_cancel;
                String SeRxpath_GPSexecute_lable;
                String SeRxpath_GPSexecute_TNinput;
                String SeRxpath_GPSexecute_save1;
                String SeRxpath_GPSexecute_acccode;
                String SeRxpath_GPSexecute_acccode1;
                
  public GPSSequentialRing()
  {
  }
  
  public GPSSequentialRing(String path) {
                                this.path = path;
                }
  
  public void turnOnOff(String feature, WebDriver driver, String br,int tab,int divval) throws InterruptedException, IOException
  {	  
	  int tab1=tab;
		...
		driver.findElement(By.xpath(SeRxpath_GPSexecute_turnOnOff)).click();
		
		Thread.sleep(6000);
		
		focusClick(driver,driver.findElement(By.xpath(SeRxpath_GPSexecute_save)),br);
...
public void turnOnOffSelected(String feature,WebDriver driver, String br, int numSuspended,int tab,int divval) throws InterruptedException, IOException
  {
	int tab1=tab;
		 ...
		 rand1=Integer.parseInt(randomNO(1,rowCount-1));
		  ...
		  //WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(SeRxpath_GPSexecute_save)));
  ...
  public void Unsavedpopup(String br, WebDriver driver, int divval,int tab,String feature) throws InterruptedException
  {
	  ...
	  driver.findElement(By.cssSelector("#accordion_SequentialRing > div.header-right > div.align-right")).click();
  }
  
  public void Cancel(String br,WebDriver driver, String feature,int tab,int divval) throws InterruptedException
  { 	  
      focusClick(driver,driver.findElement(By.xpath(SeRxpath_GPSexecute_turnOnOff)),br);
    	
      driver.findElement(By.xpath(SeRxpath_GPSexecute_cancel)).click();
      		  
	  Thread.sleep(2000);
      if(!(driver.findElement(By.xpath(SeRxpath_GPSexecute_cancel)).isEnabled()))
      {
    	  logger.info("Success");
    	 // state="Pass";
  ...
  public void turnoff(WebDriver driver, String br, String acc,int divval, String feature,int val)
  	{
                  ...
                  focusClick(driver,driver.findElement(By.xpath(SeRxpath_GPSexecute_lable+"/tbody["+TN1+"]/tr[2]/td/div/div/div/div[1]/span[1]/label")),br);
                  
                  for(int i=1;i<100;i++){}

                  focusClick(driver,driver.findElement(By.xpath(SeRxpath_GPSexecute_save1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/div[2]/button[2]")),br);
                  int chk=0;
                  do{
                	  chk++;
                  }while(driver.findElement(By.cssSelector("img[alt='icon-loading.gif']")).isDisplayed());
                  ...
                  driver.findElement(By.xpath(SeRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/input")).clear();
                  driver.findElement(By.xpath(SeRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/input")).sendKeys(phoneline+num);
  ...
  public void turnOn(WebDriver driver, String br, String acc, int divval,String feature,int val) throws InterruptedException
  	{
  ...
  public void EditTn(WebDriver driver, String br,int divval,String feature,int val) throws InterruptedException
  	{  
                  for(int a1=2;a1<=6;a1++){
                  String num=randomNO(3333,6666);
                  driver.findElement(By.xpath(SeRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr["+a1+"]/td[2]/input")).clear();
                  driver.findElement(By.xpath(SeRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr["+a1+"]/td[2]/input")).sendKeys(phoneline+num);
                  if(val==2){
                   driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr["+a1+"]/td[3]/input")).clear();
      			   driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr["+a1+"]/td[3]/input")).sendKeys("8956325485");}
                  for(int i=1;i<10;i++){}
                  }
                  focusClick(driver,driver.findElement(By.xpath(SeRxpath_GPSexecute_save1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/div[2]/button[2]")),br);
                  int chk=0;
                  ...
                  driver.findElement(By.xpath("//div[@id='collapseFeature_SequentialRing']/div[3]/table/tbody/tr[2]/td/div/div/div/table/tbody/tr[2]/td[4]/div/ul/li")).click();
                  driver.findElement(By.xpath("//div[@id='collapseFeature_SequentialRing']/div[3]/table/tbody/tr[2]/td/div/div/div/table/tbody/tr[2]/td[4]/div/ul/ul/li["+n+"]")).click();
                  ...
                  {
                	  logger.info("Success");
                	  statusTracker(br,"Pass","Verify order process for Number of Rings change","Successfully be able to process order","Successfully processed order");
                  }
                  else
                  {
                	  logger.info("Fail");
                	  statusTracker(br,"Fail","Verify order process for Number of Rings change","Unable to process order","Unable to process successfully");
                  }
  	}
  ...
  public String TNcheck(String ac, String acode,WebDriver driver, int check,String br,int divval,String feature,int val) throws Exception
  {
         	...
         	int check1=check;
         	driver.findElement(By.xpath(SeRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/input")).clear();
            driver.findElement(By.xpath(SeRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/input")).sendKeys(ac);      
          
         	if(check1==2)
         	{                      
                 driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[3]/input")).clear();
                 driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[3]/input")).sendKeys(acode);
         	}
         	if(check1==3)
         	{
                 ac=2+Acccode;
                 logger.info("ac"+ac);
                 driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[3]/input")).clear();
                 driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[3]/input")).sendKeys(acode);
         	}
  ...
  public void execute(String br, WebDriver driver,String url, int loc, String name1) throws Exception {
                  ...
                  SeRxpath_GPSexecute_newfeature = GPS.getProperty("SeRxpath_GPSexecute_newfeature");
                  SeRxpath_GPSexecute_turnOnOff = GPS.getProperty("SeRxpath_GPSexecute_turnOnOff");
                  SeRxpath_GPSexecute_save = GPS.getProperty("SeRxpath_GPSexecute_save");
                  SeRxpath_GPSexecute_cancel = GPS.getProperty("SeRxpath_GPSexecute_cancel");
                  SeRxpath_GPSexecute_lable = GPS.getProperty("SeRxpath_GPSexecute_lable");
                  SeRxpath_GPSexecute_TNinput = GPS.getProperty("SeRxpath_GPSexecute_TNinput");
                  SeRxpath_GPSexecute_save1 = GPS.getProperty("SeRxpath_GPSexecute_save1");
                  SeRxpath_GPSexecute_acccode = GPS.getProperty("SeRxpath_GPSexecute_acccode");
                  SeRxpath_GPSexecute_acccode1 = GPS.getProperty("SeRxpath_GPSexecute_acccode1");  
                               ...
                               if(first==0)
                                  ...
                                  System.out.println("a");
                                    ...
                                    System.out.println("checkpoint1");
                                    	...
                                    	String feature="SequentialRing";
                                    	Actions actions = new Actions(driver);
                						WebElement mainMenu = driver.findElement(By.xpath(".//*[@id='accordion_"+feature+"']/div"));
                						actions.moveToElement(mainMenu);
                						                                                  
                						WebElement subMenu = driver.findElement(By.xpath(SeRxpath_GPSexecute_newfeature));
                						actions.moveToElement(subMenu);
                						actions.click().build().perform();
                						
                						if(driver.findElement(By.xpath(SeRxpath_GPSexecute_newfeature)).isDisplayed())
                						{
                						    System.out.println("Tooltip is coming up fine");
                						    statusTracker(br,"","Sequential Ring Modal pop up is displayed",driver.findElement(By.xpath(SeRxpath_GPSexecute_newfeature)).getText(),"");						    
                						}
                						else
                						{
                							statusTracker(br,"","Sequential Ring Modal pop up is not displayed","","");
                						}
                                    	...
                                    	try
                                    	{
                                    		...
                                    		{
                                                  statusTracker(br,"","Sequential Ring Modal slides shows are displayed","","");
                                                  ...
                                                  {
                                                	  statusTracker(br,"","Sequential Ring Modal slides Pages displayed on page navigation","","");
                                    		      }
                                                  else
                                                  {
                                            		statusTracker(br,"","Sequential Ring Modal slides Pages not displayed on page navigation","","");
                                                  }
                                                  ...
                                                  if(driver.findElements(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div[3]/div/h2")).size()>0)
                                          		  {
                                                	  statusTracker(br,"","Sequential Ring Modal slides are displayed on clicking the Close","","");
                                          		  }
                                                  else
                                                  {
                                                	  statusTracker(br,"","Sequential Ring Modal slides are not displayed on clicking the Close","","");
                                                  }
                                                  divval=3;
                                    		}
                                    	}
                                    	...
                                    	{
                                                  statusTracker(br,"","Sequential Ring Modal slides shows are not displayed from second time","","");
                                                  first=1;
                                    	}                                    	
                                    	...
                                    	{                                                  
                                    		...
                                    		statusTracker(br,"","The Sequential Ring tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[2]/div[2]/div[2]")).getText(),"");	                                    		
                                    	}
                                  
                                    	focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[1]/td[4]/button")),br);
                                                                        
                                    	int cnt=driver.findElements(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div[3]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td")).size();
                                    	System.out.println("cnt"+cnt);
                                    	if(cnt<=4)
                                    	{                                   
                                    		if(driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div[3]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]")).getText().contains("Local Calls Only"))
                                    		{
                                    			int a1=1,val=4;                                      
                                    			focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/div/div/i")),br);
                                    			...
                                    			String acntcd= driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/div/div/input")).getAttribute("class");
                                    			logger.info("acntcd is"+acntcd);
                                    			if(acntcd.contains("not"))
                                    			{
                                    				logger.info("check is");
                                    				statusTracker(br,"","The Account code is"+Acccode,"","");    
                                    				focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/div/div/label")),br);           
                                    				driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[3]/input")).sendKeys(Acccode);
                                    			}
                                    			else
                                    			{
                                    				driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[3]/input")).clear();
                                    			...
                                    			boolean status= driver.findElement(By.xpath(SeRxpath_GPSexecute_lable+"/tbody["+TN1+"]/tr[2]/td/div/div/div/div[1]/span[1]/label/span")).isSelected();                                          
                                    			if(status==true)
                                    			{
                                    ...
                                    {
                                    	int a2=2,val=3;       
                            			focusClick(driver,driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/thead/tr/th[3]/i")),br);
                                		statusTracker(br,"","The Non-verified accountcode tool tip containt is",driver.findElement(By.xpath(".//*[@id='collapseFeature_"+feature+"']/div["+divval+"]/table/tbody["+TN1+"]/tr[2]/td/div/div/div/table/thead/tr/th[3]/div/div[2]")).getText(),"");
                            			
                            			driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[3]/input")).clear();
                            			driver.findElement(By.xpath(SeRxpath_GPSexecute_acccode1+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[3]/input")).sendKeys("8956325485");
                            			...
                            			driver.findElement(By.xpath(SeRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/input")).clear();
                                        driver.findElement(By.xpath(SeRxpath_GPSexecute_TNinput+"/tbody["+TN1+"]/tr[2]/td/div/div/div/table/tbody/tr[2]/td[2]/input")).sendKeys("9193220001");
