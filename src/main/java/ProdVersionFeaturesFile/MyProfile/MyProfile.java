package ProdVersionFeaturesFile.MyProfile;
...
public MyProfile(String path) {
  ...
  public String LoginandSecurity(String br,WebDriver driver)throws Exception
  {
         ...
         focusClick(driver,driver.findElement(By.linkText("Edit Username")),br);
          ...
          String num=randomNO(1,100);
         String s1="Apollo_user"+num;
       ...
       //if( focusClick(driver,driver.findElement(By.xpath("//html/body/section/div[6]/div/div/ul/li")),br))
              ...
              String Message=driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[1]/div[2]/div[1]/div[1]/label")).getText();
       ...
       if((driver.findElements(By.xpath("//html/body/section/p[1]/strong")).size()>0))
         ...
         if(driver.findElements(By.xpath("/html/body/section/div[7]/div[1]/div[4]/div[2]/form[1]/div[1]/div[1]/div")).size()>0)
         {      
          statusTracker(br,"Pass","Verify if User is able to see error message for Blank Username","Error Message for Blank Username :"+driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[4]/div[2]/form[1]/div[1]/div[1]/div")).getText(),"User should be able to see error message for blank Username");
         }
     else
     { 
     ...
     { 
        statusTracker(br,"Fail","Verify if User is able to see error message for for less than 4 characters in Username","User is not able to see error message  for less than 4 characters in  Username ","User should be able to see error message for less than 4 characters in  Username");     
         ...
         driver.findElement(By.id("unfuserName")).clear();
         driver.findElement(By.id("unfuserName")).sendKeys("Apollo_373146401");
         
         focusClick(driver, driver.findElement(By.xpath("(//button[@type='submit'])[4]")),br);
         
         focusClick(driver,driver.findElement(By.linkText("Edit Password")),br);
           driver.findElement(By.id("pwfPassword")).clear();
           driver.findElement(By.id("pwfPassword")).sendKeys("password1");
           driver.findElement(By.id("pwfNewPassword")).clear();
           driver.findElement(By.id("pwfNewPassword")).sendKeys("password1");
           driver.findElement(By.id("pwfConfPassword")).clear();
           driver.findElement(By.id("pwfConfPassword")).sendKeys("password1");
           focusClick(driver, driver.findElement(By.xpath("(//button[@type='submit'])[6]")),br);
           
           if( focusSearch(driver,driver.findElement(By.xpath("//html/body/section/div[6]/div/div/ul/li")),br))
                 statusTracker(br,"Pass","Verify if User is able to see error message for Same Password","Error Message for same Current and New Password:"+driver.findElement(By.xpath("//html/body/section/div[6]/div/div/ul/li")).getText(),"User should be able to see error message for same password");
           ...
           focusClick(driver, driver.findElement(By.xpath("(//button[@type='submit'])[6]")),br);
           if( focusSearch(driver,driver.findElement(By.xpath("//html/body/section/div[6]/div/div/ul/li")),br))
                 statusTracker(br,"Pass","Verify if User is able to see error message for Invalid Current Password","Error Message for Invalid Current Password:"+driver.findElement(By.xpath("//html/body/section/div[6]/div/div/ul/li")).getText(),"User should be able to see error message for wrong current password");
           ...
           //Select A= new Select(driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[4]/div[2]/div[6]/form/div[6]/span/select")));
           //  System.out.println("dfdgdg"+A);                                               
           //A.selectByVisibleText("What is the name of the street you grew up on?");
           
           focusDropdown(driver,"//html/body/section/div[7]/div[1]/div[4]/div[2]/div[6]/form/div[6]/span","What is the name of the street you grew up on?",br);
           System.out.println("done");
           if(driver.findElements(By.xpath("/html/body/section/div[7]/div[1]/div[4]/div[2]/div[6]/form/div[6]/span/div")).size()>0)
           ...
           focusClick(driver,driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[4]/div[2]/div[6]/form/div[11]/button[1]")),br);
           ...
           { 
             statusTracker(br,"Pass","Verify if User is able to see error message for wrong password in Security Question tab"+Error,"Error Message displayed for Wrong Password:","User should be able to see error message for wrong password in Security Question tab");
           }                                                                                                                                                                                         
            else
            {
...
public String EditUser(String br,WebDriver driver) throws Exception
  {
         ...
         focusClick(driver, driver.findElement(By.xpath("//html/body/section/div[7]/div[1]/div[1]/div[2]/div[2]/div/div[2]/a")),br);
      ...
      Thread.sleep(3000);
      String Edit=driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[1]/div[2]/div[1]/div[1]/label")).getText();
      ...
      if((driver.findElements(By.xpath("/html/body/section/div[7]/div[1]/div[2]/div[2]/form/div[2]/div[1]/div")).size()>0)&&(driver.findElements(By.xpath("/html/body/section/div[7]/div[1]/div[2]/div[2]/form/div[4]/div[1]/div")).size()>0))
      {                                                   
       statusTracker(br,"Pass","Verify if User is able to see error message for blank first name and last name","Error Message Displayed for Blank First Name and Last Name:"+driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[2]/div[2]/form/div[2]/div[1]/div")).getText(),"User should be able to see error message for blank first name and last name");
      }
      else
      {
     ...
     driver.findElement(By.id("ueemailAddress")).clear();
      if(driver.findElements(By.xpath("/html/body/section/div[7]/div[1]/div[2]/div[2]/form/div[6]/div[1]/div")).size()>0)
      {  statusTracker(br,"Pass","Verify if User is able to see error message for blank email","Error Message Displayed for Blank Email Address:"+driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[2]/div[2]/form/div[6]/div[1]/div")).getText(),"User should be able to see error message for blank email");
      }
     else
     {
  ...
  public String Unsavedpopup(String br,WebDriver driver) throws InterruptedException
  {
     ...
     Boolean CH=  focusSearch(driver,driver.findElement(By.xpath("/html/body/div[2]/div")),br);
       ...
       focusClick(driver,driver.findElement(By.linkText("Home")),br);
       System.out.println("done");
    //   driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/a/span")),br);
       System.out.println("done1");    
         if(driver.findElements(By.xpath("/html/body/header/div[4]/div[2]/nav/ul/li[1]/a")).size()>0)
         {
               System.out.println("Struck here1");
  ...
  public String Cancel(String br,WebDriver driver)
  {
      ...
      String Before=driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[1]/div[2]/div[2]/div/div[1]/div[2]/span")).getText();
      System.out.println(Before);
      focusClick(driver,driver.findElement(By.linkText("Edit User Info")),br);
      driver.findElement(By.id("ueemailAddress")).clear();
      focusClick(driver,driver.findElement(By.cssSelector("button.btn.btn-secondary")),br);
      String After=driver.findElement(By.xpath("/html/body/section/div[7]/div[1]/div[1]/div[2]/div[2]/div/div[1]/div[2]/span")).getText();
  ...
  public void execute(String br, WebDriver driver, String url, int loc, String name1) throws Exception {
        ...
        driver.manage().timeouts().implicitlyWait(tlim,TimeUnit.MINUTES);
        logger.info("qtest1");
        try {
        if(first==0)
            {
